...
const pageTitles: Record<string, string> = {
  accueil: 'LA REDOUTE SARL-U - Distribution Professionnelle au Togo',
  automobile: 'Automobile - Pneus & Huiles Moteurs | LA REDOUTE SARL-U',
  agroalimentaire: 'Agroalimentaire - Riz, Pâtes & Huiles | LA REDOUTE SARL-U',
  about: 'À Propos - Notre Histoire | LA REDOUTE SARL-U',
  contact: 'Contactez-nous | LA REDOUTE SARL-U',
}
